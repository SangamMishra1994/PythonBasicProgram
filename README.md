...
1. [x] [Text and String Manipulation Projects](./1_text_n_string_manipulation/readme.md)
2. [x] [Number and Math Logic Projects](./2_numbers_n_math_logic/)
3. [x] [Simple CLI Games](./3_simple_cli_games/)
4. [x] [Practical Utilities](./4_practical_utilities/)
5. [x] [Basic Conditional Program](./basic_conditional_programs/)
6. [x] [Loops in Python](./6_loops_in_python/)
7. [x] [OOPS concept in Python](./7_oops_programing_question/)
8. [x] [Dates, Time & Automation](./8_dates_time_automation/)
9. [x] [File Handling (Input/Output)](./9_file_handling/)
...
10. [ ] [Binary Search Questions](./14_leetcode_dsa_questions/10_binary_Search_questions/)
